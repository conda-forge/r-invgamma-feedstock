...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-invgamma-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9119&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-invgamma-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-invgamma` can be installed with:

```
conda install r-invgamma
```

It is possible to list all of the versions of `r-invgamma` available on your platform with:
